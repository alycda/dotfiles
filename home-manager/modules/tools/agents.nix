...
in
{
  ...
  home.file = {
    ...
    # Cross-tool home of the always-loaded rules; Claude mounts them at
    # ~/.claude/rules (claude-code.nix), crush loads them via context_paths
    # (crush.nix).
    ".agents/rules/outbound-comment-gate.md".source = ../../../tools/agents/rules/outbound-comment-gate.md;
    ".agents/rules/docs-stay-local.md".source = ../../../tools/agents/rules/docs-stay-local.md;
