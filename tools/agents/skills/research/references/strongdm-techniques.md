...
**When to apply:** Step 4 (semantic index) is a Pyramid Summary applied to research materials: the index is the compressed top of the pyramid; `inspiration/` is the full base layer.
